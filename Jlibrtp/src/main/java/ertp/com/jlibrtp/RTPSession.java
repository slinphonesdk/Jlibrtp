...
public class RTPSession {
	...
	public static int defaultRtpPort = 16386;
	public static int defaultRTcpPort = 16387;
			 ...
			 if(this.mcSession) {
				 ...
				 while(iter.hasNext()) {
					 ...
					 try {
						 ...
						 System.out.println("RTPSession.sendData() unicast failed." + e.toString());
						 e.printStackTrace();
						 return null;
					 }
				 }
	...
	public void endSession() {
		...
		if(this.rtcpSession != null) {
			...
			if(this.mcSession) {
				...
				if (this.rtcpSession == null) return;
				if (this.rtcpSession.rtcpSock == null) return;
